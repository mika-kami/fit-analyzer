...
def sync():
    ...
    def _run():
        global _status
        _status = {
            "running": True, "step": "Opening browser…",
        ...
        try:
            with sync_playwright() as pw:
                ...
                _status["step"] = "Opening Garmin Connect…"
                ...
                if "signin" in page.url or "sso.garmin.com" in page.url:
                    _status["step"] = "Log in to Garmin Connect in the opened window…"
                ...
                _status["step"] = "Fetching workout list…"
                ...
                for idx_i, aid in enumerate(all_ids, 1):
                    ...
                    if aid in known_ids:
                        ...
                        break
                    _status["step"] = f"Downloading workout {len(results)+1}…"
